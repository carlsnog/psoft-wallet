...
public class InteresseController {
  ...
  @PostMapping("/cotacao")
  @Operation(
      summary = "Criar interesse em cotação",
      description =
          "Cria um interesse baseado na variação da cotação de um ativo (requer usuário premium)")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Cria um interesse baseado na disponibilidade do ativo")
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "201", description = "Interesse criado com sucesso"),
        @ApiResponse(responseCode = "400", description = "Dados inválidos"),
