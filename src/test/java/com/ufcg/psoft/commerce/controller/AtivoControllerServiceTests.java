...
//       assertEquals(
//           BigDecimal.valueOf(100), ativoRepository.findById(cripto.getId()).get().getValor());
//     }
...
//       assertEquals(
//           BigDecimal.valueOf(100), ativoRepository.findById(tesouro.getId()).get().getValor());
//     }
...
//       assertEquals(
//           BigDecimal.valueOf(100), ativoRepository.findById(acao.getId()).get().getValor());
//     }
//   }
// }
